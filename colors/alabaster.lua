...
elseif vim.g.alabaster_bg then
    -- terminal colors
    vim.g.terminal_color_0 = "#000000"
    ...
    local def_bg = ansi.blue
    local const_fg = "#7a3e9d"
    local active = "#ffbc5d"
    local active_blue = "#007acc"
    local string_bg = ansi.green
    local darker_fg = "#7d7d7d"
    ...
    theme = {
        ...
        --- Theme specific
        ["@AlabasterConstant"] = { fg = const_fg },
        ["@AlabasterDefinition"] = { bg = def_bg },
        ["@AlabasterPunct"] = { fg = punct_fg },
        ["@AlabasterString"] = { bg = string_bg },
        ["@AlabasterHashbang"] = { fg = dim_comment },
        --- Gitsigns
